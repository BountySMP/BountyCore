...
public class GamemodeSpectatorCommand implements CommandExecutor, TabCompleter {
    private final BountyCore plugin;

    public GamemodeSpectatorCommand(BountyCore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(plugin.getMessage("gamemode.gmsp-other", "prefix", prefix, "player", target.getName()));
