...
public class GamemodeSurvivalCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GREEN + "You have set " + prefix + target.getName() + ChatColor.GREEN + " gamemode to " + ChatColor.YELLOW + "Survival" + ChatColor.GREEN + "!");

        if (!target.equals(sender)) {
            target.sendMessage(ChatColor.GREEN + "Your gamemode has been set to " + ChatColor.YELLOW + "Survival" + ChatColor.GREEN + ".");
        }
